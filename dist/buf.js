import { decodeIPv4, decodeName, encodeIPv4, encodeName, readflags, } from "./utils.js";
export const createHeaderBuf = ({ id, qr = 1, opcode = 0, aa = 0, tc = 0, rd = 0, ra = 0, z = 0, rcode = 0, qdcount = 0, ancount = 0, nscount = 0, arcount = 0, }) => {
...
export const readHeaderBuf = (reader) => {
...
export const createQuestionBuf = ({ name, type, cls }) => {
...
export const readQuestionBuf = (reader) => {
 ...
 */
export const createAnswerBuf = ({ name, type, cls, ttl, length, rdata, }) => {
    const nameBuf = encodeName(name);
